    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btninvitefriends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey! I've been using the Messenger chat and social app. It's fun and private too. Download Messenger app from https://tinyurl.com/androidmessengerapp for free and search for my username: "+CurrentUser.userInfo.username);

    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btninvitefriends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey! I've been using the Secure chat and social app. It's fun and private too. Download Secure app for free and search for my username: "+CurrentUser.userInfo.username);
